...
{ 
  $msg= '
		  ...
		  echo '<meta http-equiv="refresh" content=2;url="index.php?mod=antrianberjalan">';
} else {
  $sql="INSERT INTO daftarberobat (nomor,nama,idpasien, tgl_berobat, jamdaftar, jam_layanan, lama, jam_kedatangan,jenispenyakit, analisis) VALUES ('$nomorbaru','{$_POST['nama']}','{$_POST['idpasien']}','{$_POST['tgl_berobat']}','$clock', '{$_POST['jam_layanan']}','$long','$jam_selesai','{$_POST['jenispenyakit']}','{$_POST['analisis']}')";
  ...
  $msg= '
          ...
          echo '<meta http-equiv="refresh" content=1;url="index.php?mod=antrianberjalan">';
  } 
} 
?> 
...
<section class="panel panel-default">
 		...
 		<div class="validation-form">
              ...
              <?php    
					$con=mysqli_connect("localhost","root","","dbklinik"); 
					$query123="select * from pasien";
					$hasil123 = mysqli_query($con,$query123); 
          ...
          <div class="col-md-12 form-group2 group-mail">
              <label class="control-label">Id Pasien</label>
                        ...
                        <select name="idpasien" onchange="changeValue(this.value)">';  
						<option>---- Select ---</option>';  
						
                    
					
					<?php 				
					while ($row123 = mysqli_fetch_array($hasil123)) {  
						echo '<option value="' . $row123['idpasien'] . '">' . $row123['idpasien'] . '</option>';  
						$jsArray .= "pasienname['" . $row123['idpasien'] . "'] ={name:'" . addslashes($row123['nama']) . "'};\n";  
					}  
            ...
            <div class="col-md-6 form-group1">
              ...
              <input type="text" required="" name="nama" id="nama">
					...
					function changeValue(id){
						document.getElementById('nama').value = pasienname[id].name;
